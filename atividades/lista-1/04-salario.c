...
int main () {
	// employeeNumber, workedHours só podem ser valores inteiros, porém os salários, como são monetários, e childrenUnder14, que será utilizado em divisão, devem pertencer ao conjunto dos Reais.
