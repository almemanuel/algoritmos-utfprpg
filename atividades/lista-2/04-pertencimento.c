...
/*
São dados um número n e quatro outros, “A”, “B”, “C”, e “D”, correspondentes, respectivamente, às extremidades dos intervalos [A,B] e [C,D], sendo A<B, C<D e A<C.
Determinar se n pertence somente ao intervalo [A,B] ou somente ao intervalo [C,D] ou se, n pertence a ambos ou se n não pertence a nenhum dos dois. Em cada caso imprimir uma mensagem conveniente.
*/

#include <stdio.h>

int main() {
    // a, b, c e d correspondem as extremidades dos intervalos [A, B] e [C, D]. number será o valor testado nos intervalos
