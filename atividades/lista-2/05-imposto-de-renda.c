...
/*
Calcule o imposto de renda de um contribuinte considerando que os dados do contribuinte são: número do CPF, número de dependentes e renda mensal. Para o contribuinte será feito um desconto de 5% de salário mínimo por dependente.
...
int main() {
    ...
    // processamento
    // salario minimo em março de 2021 era R$ 1100; considerado desconto de 5% por dependente sobre o salario minimo
