// RM 11:36
/*
Escrever um algoritmo que lê o número de identificação e as 3 notas obtidas por um aluno nas 3 verificações e a média dos exercícios que fazem parte da avaliação.
...
>=4.0 e <6.0 = D
< 4.0 = E
O algoritmo deve escrever o número do aluno, suas notas, a média dos exercícios, a média de aproveitamento, o conceito correspondente e a mensagem: "APROVADO" se o conceito for A, B, ou C e "REPROVADO" se conceito for D ou E.
*/
...
int main () {
	...
	[9, R+)  = A */
	// calculo da media
	float finalAverage = (note1 + note2 * 2 + note3 * 3 + exercisesAverage) / 7;
	// conversão para conceito de A a E
	char concept;
