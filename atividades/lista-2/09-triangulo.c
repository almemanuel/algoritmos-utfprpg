...
/*****************************************************************************************************************************************
[Algoritmos Estruturados - H. Farrer] Dados três valores X, Y e Z, verificar se eles podem ser os comprimentos dos lados de um triângulo.
Se forem, verificar se é um triângulo eqüilátero, isósceles ou escaleno. Se eles não formarem um triângulo, escreva uma mensagem.
******************************************************************************************************************************************/
